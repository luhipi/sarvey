...
You can open the exported data in any GIS software. If you use QGIS, you can use the `InSAR Explorer <https://luhipi.github.io/insar-explorer/>`_ plugin to draw the time series.
